  ...
  const arduinoSections = [
    {
      ...
      icon: "🔴",
      pins: [
        { from: "IR Left", to: "A0", purpose: "Line following (left)" },
        { from: "IR Right", to: "A1", purpose: "Line following (right)" },
        { from: "IR Side", to: "A2", purpose: "Room marker detection" },
      ],
    },
    {
      ...
      icon: "⚡",
      pins: [
        { from: "ENA", to: "D5 (PWM)", purpose: "Left motor speed" },
        { from: "IN1", to: "D2", purpose: "Left motor dir" },
        { from: "IN2", to: "D3", purpose: "Left motor dir" },
        { from: "IN3", to: "D4", purpose: "Right motor dir" },
        { from: "IN4", to: "D7", purpose: "Right motor dir" },
        { from: "ENB", to: "D6 (PWM)", purpose: "Right motor speed" },
      ],
    },
    {
      ...
      icon: "📏",
      pins: [
        { from: "Trig", to: "D8", purpose: "Trigger pulse" },
        { from: "Echo", to: "D9", purpose: "Echo return" },
    ...
    },
    {
      ...
      icon: "🔔",
      pins: [
        { from: "Buzzer +", to: "D10", purpose: "Room arrival alert" },
        { from: "LED Red", to: "D11", purpose: "No request indicator" },
        { from: "LED Green", to: "D12", purpose: "Request indicator" },
        { from: "LED Blue", to: "D13", purpose: "Listening indicator" },
      ],
    },
  ];
